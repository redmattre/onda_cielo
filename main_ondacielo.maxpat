...
,
		"classnamespace" : "box",
		"rect" : [ -116.0, -1013.0, 1336.0, 937.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 1023.0, 675.0, 24.0, 24.0 ],
					"svg" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 603.0, 1118.0, 131.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 373.0, 831.0, 131.0, 22.0 ],
					"text" : "mcs.poly~ conv_spat 6"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 373.0, 795.0, 90.0, 22.0 ],
					"text" : "conv_engine_2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 49.0, 1683.0, 147.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 526.0, 821.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 504.0, 796.0, 150.0, 20.0 ],
					"text" : "rev send"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1561.0, 1078.0, 71.0, 22.0 ],
					"text" : "fromsymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1561.0, 1118.0, 95.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1561.0, 1043.0, 61.0, 22.0 ],
					"text" : "route LOJ"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 737.0, 1388.0, 20.0, 140.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 628.0, 1478.0, 97.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 555.0, 1443.0, 40.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 526.0, 1441.0, 24.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 596.0, 1507.0, 39.0, 22.0 ],
					"text" : "gate~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 628.0, 1412.0, 47.0, 22.0 ],
					"text" : "saw~ 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1561.0, 1004.0, 77.0, 22.0 ],
					"text" : "r ---webpage"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 459.0, 1483.0, 97.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 386.0, 1448.0, 40.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 357.0, 1446.0, 24.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 427.0, 1512.0, 39.0, 22.0 ],
					"text" : "gate~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 459.0, 1417.0, 60.0, 22.0 ],
					"text" : "saw~ 120"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 75.0, 1554.0, 132.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 49.0, 1552.0, 24.0, 24.0 ],
					"presentation" : 1,
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 505.0, 1593.0, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"presentation" : 1,
...
,
					...
					"outlettype" : [ "signal", "signal", "signal", "", "dictionary" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 201.0, 1593.0, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"presentation" : 1,
				...
				"box" : 				{
					...
					"data" : 					{
						"clips" : [ 							{
								...
								"filekind" : "audiofile",
								"id" : "u170008586",
								"selection" : [ 0.157894736842105, 0.452631578947368 ],
								"loop" : 1,
								"content_state" : 								{
									"loop" : 1
								}
...
,
					...
					"outlettype" : [ "signal", "signal", "signal", "", "dictionary" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 49.0, 1593.0, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"presentation" : 1,
...
,
					...
					"outlettype" : [ "signal", "signal", "signal", "", "dictionary" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 353.0, 1593.0, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 49.0, 1640.0, 260.5, 22.0 ],
					"text" : "mc.pack~ 24"
				}
...
, 			{
				"box" : 				{
					"addpoints_with_curve" : [ 0.0, 0.0, 0, 0.0, 203.32129963898916, 6.947368421052627, 0, 0.55, 850.252707581227469, 37.578947368421026, 0, -0.455, 1024.0, 47.999999999999986, 0, -0.7 ],
